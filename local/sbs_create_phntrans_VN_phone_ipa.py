...
hungWordsToPronunciation = os.environ["SBS_DATADIR"] + "/" +  "tkekona/" + "vietnamese_babel/data" + "/dict.txt"
hungPronunciationToIpa = os.environ["SBS_DATADIR"] + "/" +  "tkekona/" + "vietnamese_babel/data" + "/g2p_dict.txt"
hungarianToIpa = os.environ["SBS_DATADIR"] + "/" +  "tkekona/" + "vietnamese_babel/data" + "/g2p_dict.txt"
Hnum = 0
Enum = 0
Znum = 0
total = 0
def main(argv):
	...
	hungarianFileFolder = os.environ["SBS_DATADIR"] + "/" + "transcripts/matched/vietnamese/phone_sampa/"
