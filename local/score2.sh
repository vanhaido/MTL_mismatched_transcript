...
stats=true
beam=6
#word_ins_penalty=-3.0,-2.5,-1.5
word_ins_penalty=5.0,4.5,6.0
min_lmwt=9
max_lmwt=40
...
#local/score2.sh /media/hai/HD/projects/SBS-mul_generate_list404/data/GO/multitask/eval20min /media/hai/HD/projects/SBS-mul_generate_list404/data/GO/lang /media/hai/HD/projects/SBS-mul_generate_list404/exp/GO/fbank/exp_train1_1000_8000/dnn4_pretrain-dbn_dnn/decode_eval20min
data=$1
lang_or_graph=$2
dir=$3
